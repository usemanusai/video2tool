      ...
      >
        ...
        {isAuthenticated ? (
          <ListItem disablePadding>
            <ListItemButton
              ...
              aria-label={String(t('navigation.logout'))}
            >
          ...
          <ListItem disablePadding>
            <ListItemButton
              ...
              aria-label={String(t('navigation.login'))}
            >
              <ListItemIcon aria-hidden="true">
                <PersonIcon />
              </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton
            ...
            aria-label={String(t('theme.toggle'))}
          >
            <ListItemIcon aria-hidden="true">
        ...
        <ListItem disablePadding>
          <ListItemButton
            ...
            aria-label={String(t('language.select'))}
          >
            <ListItemIcon aria-hidden="true">
              <LanguageIcon />
            </ListItemIcon>
          ...
          {isAuthenticated && (
            <Tooltip title={user?.email || ''}>
              <IconButton
                ...
                aria-label={String(t('navigation.profile'))}
              >
                <PersonIcon />
              </IconButton>
            </Tooltip>
